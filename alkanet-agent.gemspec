...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Auto logging agent for alkanet server'
  spec.description   = 'Auto logging agent for alkanet server'
  spec.homepage      = 'https://repos.asl.cs.ritsumei.ac.jp/ykosaka/alkanet-agent'
